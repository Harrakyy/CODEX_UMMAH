...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-3">
    <div class="container">
      <a class="navbar-brand arabic-font" href="#">Nasrotul Ummah</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="daftarumroh.html">Daftar Umroh</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="umrohsaya.html">Umroh Saya</a>
          </li>
          <li class="nav-item">
  ...
  <section class="py-5 bg-light">
    <div class="container d-flex gap-4">
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          <h6 class="card-subtitle mb-2 text-muted">Syafrina Maulana</h6>
          <p class="card-text small">syafrina@gmail.com</p>
          <a href="#" class="btn btn-outline-dark w-100">Pesanan Umroh</a>
        </div>
      </div>
      <div class="card flex-fill">
        <div class="card-body">
          <h6 class="card-title">Umroh keberangkatan tanggal 24-06-2025</h6>
          <p class="card-text text-muted small">
          <button type="button" class="btn btn-danger">Hapus</button>  <button type="button" class="btn btn-primary">Update</button>
